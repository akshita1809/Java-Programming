...
public class test{
    public static void main(String[] args) {
        ...
        int height= Integer.parseInt( JOptionPane.showInputDialog("enter your height in cm:")); //takes input of height from user
        JOptionPane.showMessageDialog(null, "you are "+ height+ "cm tall"); //output=height
